...
if(isset($_POST['add_to_cart'])){
    ...
    if(mysqli_num_rows($select_cart) > 0){
        $message[] = "product gan marhore aya lagu sodaray";
    }else{
        ...
        $message[] = "Wad kuguley satay inad kuso darto";
    }
}
...
<div class="container">
    <section class="products">
        <h1 class="heading">
            Product yadii ugu dambeysay</h1>
...
<!-- Qebta ay yalan inta product aad sogalisay  -->
            ...
            <form action="" method="post">
                ...
                <input type="submit" class="btn" value="add cart" name="add_to_cart">
                </div>
            </form>
